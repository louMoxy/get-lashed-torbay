...
export default function App() {
  ...
  return (
    ...
    <Box sx={{ background: '#df7b6d', m: 0, p: 3 }} id="contact" >
      ...
      <Box sx={{ backgroundPosition: 'center', backgroundImage: `url(${img1.src})`, backgroundAttachment: 'fixed', backgroundSize: 'cover' }}>
      ...
      <Box sx={{ px: isLarge ? 14 : 2, py: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        {isLarge ? <Box sx={{ width: '90% '}}>
          <img src={img3.src} width={'100%'} />
        </Box> : null}
      </Box>
      <Box sx={{ p: isLarge ? 8 : 0, backgroundImage: `url(${pattern.src})`, backgroundSize: 'cover' }}  ref={formRef}>
